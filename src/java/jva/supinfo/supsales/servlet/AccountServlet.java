 ...
 * @author Fairuz
 */
@WebServlet(name = "AccountServlet", urlPatterns = {"/auth/account"})
public class AccountServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        _aUser = (Users) request.getSession().getAttribute("userObj");
        
        request.getRequestDispatcher("../"+SupSalesUtils.webfileRoot+"/MyAccount.jsp").forward(request, response);
    }
