...
public final class UploadImg extends Product{
    private static final String CHAMP_FICHIER     = "itempicture";
    ...
    public UploadImg(Product p){
        super();
        this.p = p;
    }
    public Product enregistrerFichier( HttpServletRequest request, String chemin ) {
        ...
        if ( erreurs.isEmpty() ) {
            ...
            p.setProductPicture(nomFichier );
        }
